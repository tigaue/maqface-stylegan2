...
and [ReStyle](https://github.com/yuval-alaluf/restyle-encoder "ReStyle"). For the image editing, our method are based on [InterfaceGAN](https://github.com/genforce/interfacegan "InterfaceGAN") and [StyleSpace-pytorch](https://github.com/xrenaa/StyleSpace-pytorch "StyleSpace-pytorch").
